...
1. By 3 March 2022, everything looks good with Visual Studio Code (Version: 1.64.2) + Python 3.10.2. Additionaly, I would like to thankfully acknowledge [TuShare Pro](https://tushare.pro/) for its valuabale data.
