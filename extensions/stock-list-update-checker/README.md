...
1. By 21 July 2022, everything looks good with Visual Studio Code (Version: 1.69.2) + Python 3.9. Additionaly, I would like to thankfully acknowledge [Tushare Pro](https://tushare.pro/) for its valuabale data.
