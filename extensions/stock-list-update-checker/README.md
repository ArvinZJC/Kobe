...
1. By 6 August 2022, everything looks good with Visual Studio Code (Version: 1.70.0) + Python 3.9. Additionaly, I would like to thankfully acknowledge [Tushare Pro](https://tushare.pro/) for its valuabale data.
