...
1. By 8 January 2023, everything looks good with Visual Studio Code (Version: 1.74.2) + Python 3.9. Additionally, I would like to thankfully acknowledge [Tushare Pro](https://tushare.pro/) for its valuabale data.
