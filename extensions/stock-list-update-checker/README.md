...
1. By 16 June 2022, everything looks good with Visual Studio Code (Version: 1.68.1) + Python 3.9. Additionaly, I would like to thankfully acknowledge [Tushare Pro](https://tushare.pro/) for its valuabale data.
