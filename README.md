...
1. 此项目使用 [GPL-3.0 协议](./LICENSE)。截至 2022 年 5 月 22 日，使用 Visual Studio Code（版本：1.67.2）、Node.js 16.15.0 和 Vue CLI 4.5.17 开发表现良好。此外，我要特别感谢 Syncfusion 提供的[强大的 Vue.js 的 UI 组件库](https://www.syncfusion.com/vue-ui-components)，以及 Tailwind 提供的[丰富、可扩展的 CSS 框架和资源](https://tailwindcss.com/resources)，这节省了许多开发时间。
...
3. 项目主要依赖参见下面的表格。更多信息请参见 [`package.json`](./package.json)。
   ...
   | @syncfusion/ej2-vue-calendars    |  20.1.56   |
   | @syncfusion/ej2-vue-dropdowns    |  20.1.56   |
   | @syncfusion/ej2-vue-grids        |  20.1.56   |
   | @syncfusion/ej2-vue-inputs       |  20.1.55   |
   | @syncfusion/ej2-vue-navigations  |  20.1.56   |
   | @syncfusion/ej2-vue-popups       |  20.1.55   |
   | @syncfusion/ej2-vue-splitbuttons |  20.1.55   |
   | cldr-data                        |   36.0.1   |
   | electron                         |   18.2.4   |
